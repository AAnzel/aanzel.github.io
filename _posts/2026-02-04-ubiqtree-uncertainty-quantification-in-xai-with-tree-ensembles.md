...
{% assign label-html = "Dubey, A., **Anžel, A.**, İlgen, B., & Hattab, G. (04 2026). *UbiQTree: Uncertainty quantification in XAI with tree ensembles*. Patterns (New York, N.Y.), 7(4), 101454. [https://doi.org/10.1016/j.patter.2025.101454](https://doi.org/10.1016/j.patter.2025.101454){:target='_blank'}
