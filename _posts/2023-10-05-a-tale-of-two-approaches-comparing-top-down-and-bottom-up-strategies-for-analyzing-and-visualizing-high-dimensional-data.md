---
title: "A Tale of Two Approaches: Comparing Top-Down and Bottom-Up Strategies for Analyzing and Visualizing High-Dimensional Data"
excerpt: The rapid growth of high-throughput technologies has led to increasingly complex, high-dimensional datasets that challenge traditional storage and analysis methods. Emerging solutions such as DNA-based data storage and machine learning-driven multi-modal analysis offer scalable and efficient alternatives. This work explores top-down and bottom-up approaches for managing, analyzing, and visualizing complex data, highlighting their applications and integration across domains.
categories:
  - Data-Visualization
  - Model-Evaluation
  - Bioinformatics
...
classes: wide
header:
  teaser: /assets/images/Publication_images/dissertation_overview.webp
---

<br>

[![Master thesis image]({{ site.url }}{{ site.baseurl }}/assets/images/Publication_images/dissertation_overview.webp)](https://doi.org/10.17192/z2023.0533){:target="_blank" alt="Aleksandar Anžel's (Aleksandar Anzel's) research image. A Tale of Two Approaches: Comparing Top-Down and Bottom-Up Strategies for Analyzing and Visualizing High-Dimensional Data."}


{% assign label-html = "**Anžel, A.** (2023). *A Tale of Two Approaches: Comparing Top-Down and Bottom-Up Strategies for Analyzing and Visualizing High-Dimensional Data*. Philipps-Universität Marburg, 2023-10-05. [https://doi.org/10.17192/z2023.0533](https://doi.org/10.17192/z2023.0533){:target='_blank'}.
{:.small-text}" | markdownify %}

{% capture anzel20232 %}
```bibtex
@phdthesis{Anzel2023-10-05,
author = {Anžel, Aleksandar},
title = {A Tale of Two Approaches: Comparing Top-Down and Bottom-Up Strategies for Analyzing and Visualizing High-Dimensional Data},
year = {2023},
month = {10},
day = {05},
doi = {https://doi.org/10.17192/z2023.0533},
...
id="2023-10-05-a-tale-of-two-approaches-comparing-top-down-and-bottom-up-strategies-for-analyzing-and-visualizing-high-dimensional-data"
label=label-html
content=anzel20232
%}
