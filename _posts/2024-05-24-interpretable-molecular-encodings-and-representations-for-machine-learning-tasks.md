...
excerpt: iCAN delivers interpretable carbon-neighborhood encodings for organic molecules, outperforming prior methods in peptide/protein classification across large biomedical datasets (71% win rate vs. structure-based baselines). It enables pattern visualization, relevance heatmaps, and versatile ML input for exotic amino acids, cyclic peptides, and proteins—accelerating drug discovery and diagnostics.
categories:
  - Molecular-Modeling
  - Machine-Learning
  - Bioinformatics
...
classes: wide
header:
  teaser: /assets/images/Publication_images/iCAN.webp
---
...
{% assign label-html = "Weckbecker, M., **Anžel, A.**, Yang, Z., & Hattab, G. (2024). *Interpretable Molecular Encodings and Representations for Machine Learning Tasks*. Computational and Structural Biotechnology Journal, 23, 2326–2336. [https://doi.org/10.1016/j.csbj.2024.05.035](https://doi.org/10.1016/j.csbj.2024.05.035){:target='_blank'}
{:.small-text}" | markdownify %}

{% capture weckbecker2024 %}
```bibtex
...
id="2024-05-24-interpretable-molecular-encodings-and-representations-for-machine-learning-tasks"
label=label-html
content=weckbecker2024
%}
