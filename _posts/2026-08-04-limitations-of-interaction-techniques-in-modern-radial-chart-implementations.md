...
excerpt: Radial visualization is widely used for analyzing complex multivariate data, but its interactive capabilities remain inconsistent across modern visualization libraries. This study reviews existing tools and highlights strengths in Focus+Context and Multiple Views while identifying key gaps in Interaction with Dimensions and domain-specific methods, offering insights for improving future radial visualization systems.
categories:
  - Data-Visualization
  - User-Interfaces
classes: wide
header:
  teaser: /assets/images/Publication_images/radial_limitations.webp
---

<br>


[![Radial Limitations image]({{ site.url }}{{ site.baseurl }}/assets/images/Publication_images/radial_limitations.webp)](https://doi.org/10.1007/s10791-026-10416-2){:target="_blank" alt="Aleksandar Anžel's (Aleksandar Anzel's) research image. Limitations of interaction techniques in modern radial chart implementations."}

{% assign label-html = "**Anžel, A.**, Hattab, G. (2026). *Limitations of interaction techniques in modern radial chart implementations*. Discover Computing, 29(1). [https://doi.org/10.1007/s10791-026-10416-2](https://doi.org/10.1007/s10791-026-10416-2){:target='_blank'}
{:.small-text}" | markdownify %}


{% capture anzel20260804 %}
```bibtex
@Article{Anžel2026,
...
id="2026-08-04-limitations-of-interaction-techniques-in-modern-radial-chart-implementations"
label=label-html
content=anzel20260804
%}
