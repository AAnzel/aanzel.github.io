...
excerpt: "Genomic AI models like Nucleotide Transformer and Evo are advancing DNA and protein design, enabling breakthroughs such as AI-created bacteriophages. However, these innovations also introduce significant risks around misuse, bias, and safety, now addressed under the EU AI Act’s high-risk classification."
categories:
  - AI-Ethics
  - Machine-Learning
  - Explainable-AI
...
classes: wide
header:
  teaser: /assets/images/Publication_images/ai_genomics_durc.webp
---

<br>


[![AI safety in genomics]({{ site.url }}{{ site.baseurl }}/assets/images/Publication_images/ai_genomics_durc.webp)](https://doi.org/10.1016/j.tig.2026.04.001){:target="_blank" alt="Aleksandar Anžel's (Aleksandar Anzel's) research image. A safety-centric perspective on innovation and risk in the use of artificial intelligence in genomics."}


{% assign label-html = "Hassan, H. A., **Anžel, A.**, İlgen, B., Luchner, M., Schramowski, P., Blasse, A., … Sprang, M. (2026). *A safety-centric perspective on innovation and risk in the use of artificial intelligence in genomics*. Trends in Genetics. [https://doi.org/10.1016/j.tig.2026.04.001](https://doi.org/10.1016/j.tig.2026.04.001){:target='_blank'}
...
id="2026-04-29-a-safety-centric-perspective-on-innovation-and-risk-in-the-use-of-artificial-intelligence-in-genomics"
label=label-html
content=hassan2026
%}
