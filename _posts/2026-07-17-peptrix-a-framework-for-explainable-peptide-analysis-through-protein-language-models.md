...
{% assign label-html = "Schilling, V., Dubey, A., **Anžel, A.**, & Hattab, G. (2026). *PepTriX: A Framework for Explainable Peptide Analysis through Protein Language Models*. Next Research, 102151. [https://doi.org/10.1016/j.nexres.2026.102151](https://doi.org/10.1016/j.nexres.2026.102151){:target='_blank'}
